        ...
        <div className='container'>
            <div className='testimonials-content'>
                <div className='section-t text-center'>
                    <h3 className='text-white'>Student Testimonials</h3>
                </div>
                        ...
                        sections.testimonials.map(testimonial => {
                            ...
                            return (
                                <div className='item translate-effect bg-dark' key = {testimonial.id}>
                                    ...
                                    <h4 className='item-name text-white'>{testimonial.name}</h4>
                                    <p className='item-text text-white'>{testimonial.text}</p>
