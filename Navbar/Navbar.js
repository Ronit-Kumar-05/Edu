...
import LOGO from '../../assets/images/log1.jpeg';
        ...
        <div className='container w-100'>
            <div className='navbar-content flex fw-7'>
                ...
                <img src={LOGO} alt="logo" className='LOGO'/>
                    {/* <Link to = "/" className='navbar-brand fs-26'>ST. JOSEPH</Link> */}
                ...
                <div className={`navbar-collapse ${navToggle ? 'show-navbar-collapse' : ""}`}>
                    <div className='navbar-collapse-content'>
                        ...
                        <div className='navbar-btns'>
                            <button type = "button" className='btn'><IoMdRocket /> <span><a href="http://ivs.edupto.com/" target='blank'>Login</a></span></button>
                        </div>
                    </div>
                </div>
            </div>
